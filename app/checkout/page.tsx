        ...
        <Container className="lg:max-w-5xl mx-auto p-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
            <div className="lg:col-span-8">
                <div className="flex items-center gap-4 mb-8 text-sm font-medium">
                    <span className={step >= 1 ? "text-secondary hover:text-secondary/60 cursor-pointer" : "text-accent-4"} onClick={() => goBack(1)} >Info</span>
                    <div className="h-px w-8 bg-accent-2" />
                    <span className={step >= 2 ? "text-secondary hover:text-secondary/60 cursor-pointer" : "text-accent-4"} onClick={() => goBack(2)}>Shipping</span>
                    <div className="h-px w-8 bg-accent-2" />
                    <span className={step >= 3 ? "text-secondary hover:text-secondary/60 cursor-pointer" : "text-accent-4"} onClick={() => goBack(3)}>Payment</span>
                </div>
