<div className="space-y-4">
  <div className="flex items-center justify-between">
    ...
    <Button type="button" variant="slim" onClick={addVariant} className="gap-2">
      ...
      {variant.isExpanded && (
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2 gap-6">
              <InputSelect
                ...
                onChange={(e) =>
                  updateVariant(variant.id, "sizeName", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <InputCheck
            ...
            className="h-6 w-6"
            onChange={(e) =>
              updateVariant(variant.id, "availableForSale", e.target.checked)
            }
          />
            ...
            {variant.details?.map((detail: any, dIdx: number) => (
              <div key={dIdx} className="flex gap-2 items-center">
                <InputSelect
                  ...
                  onChange={(e) =>
                    updateDetail(variant.id, dIdx, "title", e.target.value)
                  }
                />
                <Input
                  className="flex-1"
