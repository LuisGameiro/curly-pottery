...
import { ArrowBigDown, ArrowDown, ArrowDownWideNarrow, ChevronDown } from "lucide-react";
        ...
        <aside className="gap-2 lg:col-span-3 flex flex-col sm:flex-row lg:flex-col ">
          <div className="relative w-full z-30">
            ...
            >
              ...
              <ChevronDown size={18} className={cn("transition-transform", openSort && "rotate-180")} />
