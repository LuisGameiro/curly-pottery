        ...
        <main className="bg-gradient-to-r from-accent-4 to-accent-9">
            <section className="pt-8 px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    <h1 className="text-4xl font-bold text-primary mb-4">About Curly Pottery</h1>
                ...
                <div className="max-w-3xl mx-auto space-y-6">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <p className="text-primary-2 ">
                            At Curly Pottery, we believe in creating beautiful, functional ceramics that bring joy to everyday life. 
                            Each piece is carefully handcrafted with attention to detail and quality.
                        </p>

                        <h2 className="text-2xl font-bold text-primary my-2 mt-6">Our Mission</h2>
                        <p className="text-primary-2 mb-6">
                            We're dedicated to producing sustainable, artisanal pottery that celebrates the beauty of natural materials 
                            and traditional craftsmanship.
                        </p>

                        <h2 className="text-2xl font-bold text-primary my-2 mt-6">Why Choose Us</h2>
